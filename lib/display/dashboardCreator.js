    ...
    return (
        <form onSubmit={handleSubmitInner} className="block place-centers">
            ...
            <div className="grid grid-cols-3 text-center">
                ...
                <p className="block col-start-1 col-end-4 bg-gray-200 text-gray-700  py-2 px-4 border border-transparent mt-5 p-10 text-center mb-6">You can find the necessary ids by toggling the advanced options in the search, or by visiting https://api.metaforecast.org/all-forecasts</p>
            </div>
        </form>
    );
}
